...
<table border="0" cellspacing="0" cellpadding="2" width="336">
	...
	<tr>
		...
		<td><input type="text" name="trows" id="trows" size="3" maxlength="3"
			class="input_small"></td>
		<td><?php echo $l->m('columns')?>:</td>
		<td><input type="text" name="tcols" id="tcols" size="3" maxlenght="3"
			class="input_small"></td>
	</tr>
	<tr>
		<td><?php echo $l->m('css_class')?>:</td>
		<td colspan="3"><select id="tcssclass" name="tcssclass" id="tcssclass"
			size="1" class="input" onchange="css_class_changed();">
			<?php
	...
	<tr>
		...
		<td nowrap><input type="text" name="twidth" id="twidth" size="3"
			maxlenght="3" class="input_small"> <select size="1" name="twunits"
			id="twunits" class="input_small">
			<option value="%">%</option>
			<option value="px">px</option>
		</select></td>
		<td><?php echo $l->m('height')?>:</td>
		<td nowrap><input type="text" name="theight" id="theight" size="3"
			maxlenght="3" class="input_small"> <select size="1" name="thunits"
			id="thunits" class="input_small">
			<option value="%">%</option>
			<option value="px">px</option>
		</select></td>
	</tr>
	<tr>
		...
		<td colspan="3"><input type="text" name="tborder" id="tborder"
			size="2" maxlenght="2" class="input_small"> <?php echo $l->m('pixels')?></td>
	</tr>
	<tr>
		<td><?php echo $l->m('cellpadding')?>:</td>
		<td><input type="text" name="tcpad" id="tcpad" size="3" maxlenght="3"
			class="input_small"></td>
		<td><?php echo $l->m('cellspacing')?>:</td>
		<td><input type="text" name="tcspc" id="tcspc" size="3" maxlenght="3"
			class="input_small"></td>
	</tr>
	<tr>
		<td colspan="4"><?php echo $l->m('bg_color')?>: <img src="spacer.gif"
			id="color_sample" border="1" width="30" height="18" align="absbottom">&nbsp;<input
			type="text" name="tbgcolor" id="tbgcolor" size="7" maxlenght="7"
			class="input_color" onKeyUp="setSample()">&nbsp; <img
			id="tcolorpicker"
			src="<?php echo $theme_path.'img/'?>tb_colorpicker.gif" border="0"
			onClick="showColorPicker(tbgcolor.value)" align="absbottom"></td>
	</tr>
	<tr>
		<td colspan="4"><?php echo $l->m('background')?>: <input type="text"
			name="tbackground" id="tbackground" size="20" class="input">&nbsp;<img
			id="timg_picker"
