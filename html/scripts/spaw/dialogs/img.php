...
<table border="0" cellspacing="0" cellpadding="2" width="336">
	...
	<tr>
		...
		<td colspan="3"><input type="text" name="csrc" id="csrc" class="input"
			size="32"></td>
	</tr>
	<tr>
		<td><?php echo $l->m('alt')?>:</td>
		<td colspan="3"><input type="text" name="calt" id="calt" class="input"
			size="32"></td>
	</tr>
	<tr>
		<td><?php echo $l->m('align')?>:</td>
		<td align="left"><select name="calign" id="calign" size="1"
			class="input">
			<option value=""></option>
	...
	<tr>
		...
		<td nowrap><input type="text" name="chspace" id="chspace" size="3"
			maxlength="3" class="input_small"></td>
		<td><?php echo $l->m('vspace')?>:</td>
		<td nowrap><input type="text" name="cvspace" id="cvspace" size="3"
			maxlength="3" class="input_small"></td>
	</tr>
	<tr>
		<td colspan="4" nowrap>
