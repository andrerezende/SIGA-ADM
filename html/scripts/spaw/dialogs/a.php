...
<table border="0" cellspacing="0" cellpadding="2" width="336">
	...
	<tr>
		...
		<td width="50%"><select name="catype" id="catype" size="1"
			class="input"
			onchange="changeType(this.options[this.selectedIndex].value);">
	...
	<tr id="url_row">
		...
		<td width="50%"><input type="text" name="chref" id="chref"
			class="input" size="32"></td>
	</tr>
	<tr id="name_row">
		<td width="50%"><?php echo $l->m('name')?>:</td>
		<td width="50%"><input type="text" name="cname" id="cname"
			class="input" size="32"></td>
	</tr>
	<tr id="anchor_row">
		<td width="50%"><?php echo $l->m('anchors')?>:</td>
		<td width="50%"><select name="canchor" id="canchor" size="1"
			class="input">
			<option></option>
		</select></td>
	</tr>
	<tr id="target_row">
		...
		<td width="50%" align="left"><select name="ctarget" id="ctarget"
			size="1" class="input">
			<?php
	...
	<tr id="title_row">
		...
		<td width="50%" align="left"><input type="text" name="ctitle"
			id="ctitle" size="32" class="input"></td>
	</tr>
	<tr>
		<td colspan="2" nowrap>
		<hr width="100%">
	...
	<tr>
		<td colspan="2" align="right" valign="bottom" nowrap><input
