...
--
-- Name: fk_ad_itempatrimonio6_ad_vi; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY ad_itempatrimonio
    ADD CONSTRAINT fk_ad_itempatrimonio6_ad_vi FOREIGN KEY (idvidautil) REFERENCES ad_vidautil(idvidautil);
