...
<IMG SRC="wrapper.php?p_text=BAR%20CODE%20RESULT" ALT=""></h2>
<TABLE border=1>
	<TR>
		<TD>Text</TD>
	...
	<TR>
		<TD colspan=2 align=center bgcolor=cyan><br>
		<? if ($msg != ""){ ?> <? echo $msg; ?> <? } else { ?> &nbsp; <IMG
			SRC="<? echo $dest;?>" ALT="<? echo strtoupper($p_text); ?>"> &nbsp;
			<? } ?> <br>
		<br>
		</TD>
	</TR>
	<TR>
		<TD colspan=2 align=center><a href="javascript: history.go(-1)">Back</a>
		</TD>
	</TR>
</TABLE>
</BODY>
...
<IMG SRC="wrapper.php?p_text=BAR%20CODE%20TEST" ALT=""></h2>
<FORM METHOD=POST ACTION="index.php">
<TABLE border=1>
	<TR>
		<TD>Text</TD>
		<TD><INPUT TYPE="text" NAME="p_text" VALUE="1234567890" maxlength="20"
			size=25></TD>
	</TR>
	<TR>
		<TD>Barcode Type</TD>
		<TD><SELECT NAME="p_bcType">
	...
	<TR>
		...
		<TD><INPUT TYPE="radio" NAME="p_w2n" value="2">x2 <INPUT TYPE="radio"
			NAME="p_w2n" value="3" CHECKED>x3</TD>
	</TR>
	<TR>
		<TD>Image Type</TD>
	...
	<TR>
		<TD>Label?</TD>
		<TD><INPUT TYPE="radio" NAME="p_label" value="Y" CHECKED>Yes <INPUT
			TYPE="radio" NAME="p_label" value="N">No</TD>
	</TR>
	<TR>
		<TD>Inverted?</TD>
		<TD><INPUT TYPE="radio" NAME="p_invert" value="Y">Yes <INPUT
			TYPE="radio" NAME="p_invert" value="N" CHECKED>No</TD>
	</TR>
	<TR>
		<TD>Check Digit?</TD>
		<TD><INPUT TYPE="radio" NAME="p_checkDigit" value="Y">Yes <INPUT
			TYPE="radio" NAME="p_checkDigit" value="N" CHECKED>No</TD>
	</TR>
	<TR>
		<TD>Rotate?</TD>
	...
	<TR>
		<TD colspan=2 align=center><INPUT TYPE="submit" NAME="p_submit"
			value="CONVERT"> <INPUT TYPE="reset" NAME="p_reset" value="RESET"></TD>
	</TR>
</TABLE>
</FORM>
